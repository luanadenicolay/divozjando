// Alonso Amparo, Bach Renata, Brancaleone Brunella, Cotleroff Ana y De Nicolay Luana. 
// https://youtu.be/hwiMCoUW2AM
...
let hOffsetPartes = 30;
let bNuevoPartes = 220;
let ultimoCambioColor = 0;
const intervaloCambio = 250;
let partesColor = [];
...
function preload() {
  ...
  partesCara.forEach((p, i) => {
    p.img = loadImage("data/cara" + i + ".png");
    partesColor[i] = loadImage("data/cara" + i + "color.png");
  });
}
